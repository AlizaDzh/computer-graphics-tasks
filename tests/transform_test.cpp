...
[[noreturn]] int main()
{
    ...
    auto [sphere_indices, sphere_vertices] = geometry_generators::generate_sphere_geometry_data(1.0f, 20, 20);
    ...
    moon_mesh->set_scale(glm::vec3{0.05f});
    ...
    for (;;)
    {
        ...
        //   sun_mesh->add_to_position(glm::vec3{0.0f, 0.0f, 0.015f});
        sun_mesh->add_to_rotation_y(0.015f);
        venus_mesh->add_to_rotation_y(-0.01f);
        earth_mesh->add_to_rotation_y(0.02f);
        moon_mesh->add_to_rotation_y(-0.03f);

        venus_rotator->add_to_rotation_y(-0.01f);
        earth_rotator->add_to_rotation_y(0.01f);
        moon_rotator->add_to_rotation_y(0.03f);
