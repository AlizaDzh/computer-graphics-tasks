...
[[noreturn]] int main()
{
    ...
    window->set_on_key_down([&](int key) {
        ...
        case SDLK_DOWN:
            ...
            break;
        case SDLK_7:
            point_light1->set_intensity(point_light1->get_intensity() + INTENSITY_DIFF);
            break;
        case SDLK_1:
            point_light1->set_intensity(point_light1->get_intensity() - INTENSITY_DIFF);
            break;
        case SDLK_8:
            point_light2->set_intensity(point_light2->get_intensity() + INTENSITY_DIFF);
            break;
        case SDLK_2:
            point_light2->set_intensity(point_light2->get_intensity() - INTENSITY_DIFF);
            break;
        case SDLK_9:
            material->set_specular_exponent(material->get_specular_exponent() + SPECULAR_EXPONENT_DIFF);
            break;
        case SDLK_3:
            material->set_specular_exponent(material->get_specular_exponent() - SPECULAR_EXPONENT_DIFF);
            break;
